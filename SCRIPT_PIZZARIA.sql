...
VALUES (1, '2023-25-10 17:00:00', 150.50, 1, 3, 2, 3);

-- Inserindo um registro na tabela PEDIDO_VENDA
INSERT INTO PEDIDO_VENDA (COD_PEDIDO_VENDA, DATA_PEDIDO, VLR_PEDIDO_VENDA, COD_VENDEDOR, COD_CLIENTE, COD_SITUACAO_PEDIDO, COD_FORMA_PAGAMENTO)
VALUES (6, '2023-27-10 07:00:00', 120.75, 2, 3, 3, 3);

-- Inserindo um registro na tabela PEDIDO_VENDA
INSERT INTO PEDIDO_VENDA (COD_PEDIDO_VENDA, DATA_PEDIDO, VLR_PEDIDO_VENDA, COD_VENDEDOR, COD_CLIENTE, COD_SITUACAO_PEDIDO, COD_FORMA_PAGAMENTO)
VALUES (3, '2023-27-11 05:00:00', 180.75, 2, 3, 2, 2);

-- Inserindo um registro na tabela PEDIDO_VENDA
INSERT INTO PEDIDO_VENDA (COD_PEDIDO_VENDA, DATA_PEDIDO, VLR_PEDIDO_VENDA, COD_VENDEDOR, COD_CLIENTE, COD_SITUACAO_PEDIDO, COD_FORMA_PAGAMENTO)
VALUES (4, '2023-04-11 16:00:00', 115.75, 2, 3, 3, 3);

-- Inserindo um registro na tabela PEDIDO_VENDA
INSERT INTO PEDIDO_VENDA (COD_PEDIDO_VENDA, DATA_PEDIDO, VLR_PEDIDO_VENDA, COD_VENDEDOR, COD_CLIENTE, COD_SITUACAO_PEDIDO, COD_FORMA_PAGAMENTO)
VALUES (5, '2023-3-11 19:00:00', 55.75, 2, 3, 1, 1);
...
UPDATE CLIENTE SET NOME = 'LUCAS' WHERE COD_CLIENTE  = 1;
...
-- ATIVIDADE INNER JOIN - PIZZARIA:


-- INNER JOIN PEDIDO_COMPRA / ITEM_PEDIDO_COMPRA

SELECT * FROM PEDIDO_COMPRA pc
INNER JOIN ITEM_PEDIDO_COMPRA ipc 
WHERE ipc.COD_PEDIDO_COMPRA = pc.COD_PEDIDO_COMPRA; 

-- INNER JOIN ITEM_PEDIDO_COMPRA / PRODUTO

SELECT * FROM ITEM_PEDIDO_COMPRA ipc 
INNER JOIN PRODUTO p 
WHERE ipc.COD_PRODUTO = p.COD_PRODUTO;

-- INNER JOIN COTAÇÃO / FORNECEDOR / PRODUTO 
...
AND f.COD_FORNECEDOR = 1;


-- INNER JOIN SITUAÇÃO_PEDIDO / PEDIDO_VENDA / CLIENTE

SELECT * FROM SITUACAO_PEDIDO sp 
INNER JOIN PEDIDO_VENDA pv
INNER JOIN CLIENTE c 
WHERE sp.COD_SITUACAO_PEDIDO = pv.COD_SITUACAO_PEDIDO 
AND pv.COD_CLIENTE = c.COD_CLIENTE 
AND c.COD_CLIENTE = 3;


-- INNER JOIN FORMA_PAGAMENTO / PEDIDO_VENDA / CLIENTE

SELECT fp.DES_FORMA_PAGAMENTO FROM FORMA_PAGAMENTO fp 
INNER JOIN PEDIDO_VENDA pv
INNER JOIN CLIENTE c 
WHERE fp.COD_FORMA_PAGAMENTO = pv.COD_FORMA_PAGAMENTO 
AND pv.COD_CLIENTE = c.COD_CLIENTE 
AND c.COD_CLIENTE = 3;


-- LEFT JOIN PEDIDO_VENDA / FORMA_PAGAMENTO

SELECT pv.COD_FORMA_PAGAMENTO AS PEDIDO_VENDA_FORMA_PAGAMENTO, 
fp.COD_FORMA_PAGAMENTO AS TABELA_FORMA_PAGAMENTO
FROM PEDIDO_VENDA pv 
LEFT JOIN FORMA_PAGAMENTO fp 
WHERE pv.COD_FORMA_PAGAMENTO = fp.COD_FORMA_PAGAMENTO;


-- RIGHT JOIN PEDIDO_VENDA / CLIENTE

SELECT c.NOME, COUNT(pv.COD_CLIENTE) AS QUANTIDADE_DE_PEDIDOS  FROM PEDIDO_VENDA pv 
